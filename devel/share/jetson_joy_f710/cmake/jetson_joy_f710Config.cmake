...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'jetson_joy_f710' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/mnt/home/xt19i0051/chinkara_ws/donkeycar_1906/src/jetson_joy_f710/${idir}'.  ${_report}")
    endif()
